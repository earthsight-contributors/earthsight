...
class FusedPriorityQueue():
    def __init__(self, schedule_request, priority_queue: PriorityQueue, compute_queue : Deque, low_priority_queue : PriorityQueue):
    ...
    def pop(self):
        ...
        # annotate the images
        current_time = log.get_logging_time()
        for image in self.untimed_images:
            image.earliest_possible_transmit_time = current_time
