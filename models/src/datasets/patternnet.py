...
import sys
import torch
from torchgeo.datasets import PatternNet as _PatternNet
...
class PatternNet():
    def __init__(self, batch_size):
        full_dataset = _PatternNet(root=os.path.join(os.path.dirname(os.path.abspath(sys.argv[0])), 'datasets'), download=True)
