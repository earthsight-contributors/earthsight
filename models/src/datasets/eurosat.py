...
import sys
import torch
from torchvision.datasets import EuroSAT as Euro_SAT
...
class EuroSAT():
    def __init__(self, batch_size):
        # self.num_classes
        full_dataset = Euro_SAT(root=os.path.join(os.path.dirname(os.path.abspath(sys.argv[0])), 'datasets', 'EuroSAT'), download=True)
